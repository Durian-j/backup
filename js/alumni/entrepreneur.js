...
$(document).ready(function () {
    ...
    function sendFile(files, editor, $editable) {
        ...
        $.ajax({
            data: data,
            type: "POST",
            url: "../entrepreneur/saveImageFile", //图片上传出来的url，返回的是图片上传后的路径，http格式
            cache: false,
            contentType: false,
            processData: false,
            dataType: "json",
...
$("#saveInfo").click(function () {
    mask = layer.load(1, {content:'正在上传中....',shade: [0.8, '#393D49']});
    ...
    if (defalutForm.isValid()) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                layer.msg(data.data);
                $("#bys")[0].reset();
                $("#xyList").bootstrapTable('refresh', {url: '../entrepreneur/query'});
            }
        });
    }
});
