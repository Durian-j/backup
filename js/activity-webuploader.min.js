jQuery(function () {
        ...
        if (e !== k) {
            switch (c.removeClass("state-" + k), c.addClass("state-" + e), k = e) {
                ...
                case"confirm":
                    ...
                    break;
                case"finish":
                    a = n.getStats(), a.successNum ? layer.alert("上传成功") : (k = "done", location.reload())
            }
            i()
        }
    }
    ...
    n = WebUploader.create({
        ...
        disableGlobalDnd: !0,
        chunked: !0,
        server: "../activity/upload/hdly/imgs",
        fileNumLimit: 9,
        fileSizeLimit: 94371840,
    ...
    },n.on('uploadAccept',function(object,ret){
        hdly_imgs_path.push(ret.data)
    }),c.on("click", function () {
